    ...
    public class MenuManager
    {
        ...
        public MenuManager(string heroName)
        {
            ...
            autoUsageMenu.AddItem(
                new MenuItem("BreakerSharp.KillStealSign", "KillSteal").SetFontColor(Color.LightSkyBlue));

            autoUsageMenu.AddItem(this.killSteal);
            autoUsageMenu.AddItem(this.minHpKillsteal);
            autoUsageMenu.AddItem(
                new MenuItem("BreakerSharp.ArmletToggleSign", "ArmletToggle").SetFontColor(Color.LightSkyBlue));
